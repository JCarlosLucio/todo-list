...
const uiController = (() => {
  ...
  const setupTodos = (obj) => {
    ...
    const containerTodoTitle = document.querySelector(
      DOMStrings.containerTodoTitle
    );
  ...
  const setEditInputs = (listID, todoID, obj) => {
    ...
    const containerEditTitle = document.querySelector(
      DOMStrings.containerEditTitle
    );
